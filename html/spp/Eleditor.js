...
(function(w){
	...
	w[_namespace] = function(){
		...
		var _showEditorControllerLayer = function(_$e){
			...
			console.log("  _$e.outerHeight():"+  _$e.outerHeight());
			console.log(" _$e.offset().top:"+ _$e.offset().top);
			console.log("_calTop:"+_calTop);
...
//				mui('.mui-scroll-wrapper').scroll().scrollTo(0,_calTop - 150,100);
		...
		if( typeof WebUploader != 'undefined' && typeof _args.uploader != 'function' ){
			...
			_imageUploader.on( 'uploadSuccess', function( _file, _call ) {
			    ...
			    if( _call.status == 200 ){
					...
					if( _hasStyleBarBtn ){
						_$editorTextArea.append('<img src="'+_call.data+'">');
						
					}else{
				    	_appendHistory();

						_$selected.after( $('<img src="'+_call.data+'">') );
